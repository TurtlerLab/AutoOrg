...
def organize_downloads():
    while True:
        organized = False  # Flag to track if any files were organized in this iteration
        for item in os.listdir(source_directory):
            ...
            if os.path.isfile(item_path):
                ...
                try:
                    ...
                    organized = True  # Set the flag to True if a file was organized
        ...
        if not organized:
            break  # If no files were organized in this iteration, exit the loop
